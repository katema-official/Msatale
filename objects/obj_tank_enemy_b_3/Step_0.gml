...
if(instance_exists(main)){
	if(point_in_circle(main.x,main.y,x,y,400)){
...
if(collision_line(x+22,y-16, x+22,y+16, obj_tank_down_parent,false,true)){
	right_tank=true;	
}else{
	right_tank=false;	
}
...
if(collision_line(x+16,y+22, x-16,y+22, obj_tank_down_parent,false,true)){
	down_tank=true;	
}else{
	down_tank=false;	
}
