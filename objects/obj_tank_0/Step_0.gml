...
if(keyboard_check(ord("W")) && !keyboard_check_direct(ord("D")) && !keyboard_check_direct(ord("A"))){
	vspeed = -1;
...
if(keyboard_check(ord("W")) && keyboard_check_direct(ord("D"))){
	hspeed=1;
	vspeed=-1;
...
if(keyboard_check(ord("W")) && keyboard_check_direct(ord("A"))){
	hspeed=-1;
	vspeed=-1;
...
if(keyboard_check(ord("S")) && !keyboard_check_direct(ord("D")) && !keyboard_check_direct(ord("A"))){
	vspeed = 1;
...
if(keyboard_check(ord("S")) && keyboard_check_direct(ord("D"))){
	hspeed=1;
	vspeed=1;
...
if(keyboard_check(ord("S")) && keyboard_check_direct(ord("A"))){
	hspeed=-1;
	vspeed=1;
...
if(keyboard_check(ord("D")) && !keyboard_check_direct(ord("W")) && !keyboard_check_direct(ord("S"))){
	hspeed = 1;
...
if(keyboard_check(ord("A")) && !keyboard_check_direct(ord("W")) && !keyboard_check_direct(ord("S"))){
	hspeed = -1;
